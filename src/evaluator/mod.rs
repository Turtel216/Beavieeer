...
"#,
    ...
    fn test_fn_application() {
        let tests = vec![
            (
                "let identity = fun(x) { x; }; identity(5);",
                Some(Object::Int(5)),
            ),
            (
                "let identity = fun(x) { return x; }; identity(5);",
                Some(Object::Int(5)),
            ),
            (
            ...
            ("fun(x) { x; }(5)", Some(Object::Int(5))),
            (
                "fun(a) { let f = fun(b) { a + b }; f(a); }(5);",
                Some(Object::Int(10)),
            ),
        ];
